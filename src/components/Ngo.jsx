    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-50 via-white to-blue-100">
      ...
      <div className="flex-1 flex flex-col items-center px-4 py-8">
        ...
        <div className="w-full max-w-2xl bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl p-8 
                      border-2 border-blue-400/20 hover:border-blue-400/30 transition-all duration-300 mb-12">
          <div className="flex flex-col md:flex-row gap-4">
            <select
              className="flex-1 p-3 rounded-lg border-2 border-blue-400/30 bg-white/90 
                        focus:border-blue-500/50 focus:ring-2 focus:ring-blue-200 
                        focus:outline-none text-gray-700 transition-colors duration-200"
              value={search}
            ...
            <button
              className="px-8 py-3 bg-gradient-to-r from-blue-400 to-blue-600 text-white 
                        font-semibold rounded-lg shadow-lg transform transition-all duration-300 
                        hover:scale-105 hover:shadow-xl hover:from-blue-500 hover:to-blue-700 
                        active:scale-95"
            ...
            filteredNGOs.map((ngo) => (
              <motion.div
                ...
                className="bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-xl 
                          border-2 border-blue-400/20 hover:border-blue-400/30 
              ...
              >
                ...
                />
                <h2 className="text-2xl font-bold text-blue-800 mb-2">{ngo.name}</h2>
